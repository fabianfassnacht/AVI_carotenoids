...
setwd("/home/fabi/KIT/11_AG_Angular_Index/1_new_runs/out_corrdata")
path = "car_all_2.txt"  
sink(path)
...
plot(car, (git+(AVI2(wavel[a],wavel[b],wavel[c],refl_o1[,a],refl_o1[,b],refl_o1[,c])*120)))
plot(chl, range01(git)+range01((AVI2(wavel[a],wavel[b],wavel[c],refl_o1[,a],refl_o1[,b],refl_o1[,c]))))
plot(car, range01(chap)+range01((AVI2(wavel[a],wavel[b],wavel[c],refl_o1[,a],refl_o1[,b],refl_o1[,c]))))

cor(car, (chap+(AVI2(wavel[a],wavel[b],wavel[c],refl_o1[,a],refl_o1[,b],refl_o1[,c])*120)))
cor(chl, range01(chap)+range01((AVI2(wavel[a],wavel[b],wavel[c],refl_o1[,a],refl_o1[,b],refl_o1[,c]))))
cor(chl, range01(git)+range01((AVI2(wavel[a],wavel[b],wavel[c],refl_o1[,a],refl_o1[,b],refl_o1[,c]))))

cor(car, chap)
cor(chl, (AVI2(wavel[a],wavel[b],wavel[c],refl_o1[,a],refl_o1[,b],refl_o1[,c])))
cor(chl, chap)
...
cor(chl_m, (chap_m+(AVI2(wavel[a],wavel[b],wavel[c],refl_m[,a],refl_m[,b],refl_m[,c])*120)))
cor(chl_c, (chap_c+(AVI2(wavel[a],wavel[b],wavel[c],refl_c[,a],refl_c[,b],refl_c[,c])*120)))
cor(chl_b, (chap_b+(AVI2(wavel[a],wavel[b],wavel[c],refl_b[,a],refl_b[,b],refl_b[,c])*120)))

cor(chl_m, (range01(chap_m)+range01((AVI2(wavel[a],wavel[b],wavel[c],refl_m[,a],refl_m[,b],refl_m[,c])))))
cor(chl_c, (range01(chap_c)+range01((AVI2(wavel[a],wavel[b],wavel[c],refl_c[,a],refl_c[,b],refl_c[,c])))))
cor(chl_b, (range01(chap_b)+range01((AVI2(wavel[a],wavel[b],wavel[c],refl_b[,a],refl_b[,b],refl_b[,c])))))
...
cor(chl_m, (range01(git_m)+range01((AVI2(wavel[a],wavel[b],wavel[c],refl_m[,a],refl_m[,b],refl_m[,c])))))
cor(chl_c, (range01(git_c)+range01((AVI2(wavel[a],wavel[b],wavel[c],refl_c[,a],refl_c[,b],refl_c[,c])))))
cor(chl_b, (range01(git_b)+range01((AVI2(wavel[a],wavel[b],wavel[c],refl_b[,a],refl_b[,b],refl_b[,c])))))
cor(chl, range01(git)+range01((AVI2(wavel[a],wavel[b],wavel[c],refl_o1[,a],refl_o1[,b],refl_o1[,c]))))
...
cor(chl_m, AVI2(wavel[a],wavel[b],wavel[c],refl_m[,a],refl_m[,b],refl_m[,c]))
cor(chl_c, AVI2(wavel[a],wavel[b],wavel[c],refl_c[,a],refl_c[,b],refl_c[,c]))
cor(chl_b, AVI2(wavel[a],wavel[b],wavel[c],refl_b[,a],refl_b[,b],refl_b[,c]))
