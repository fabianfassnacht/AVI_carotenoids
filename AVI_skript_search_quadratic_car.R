...
for(k in 1:36) { 
  ...
  for (j in j1:37) {
    ...
    for (h in h1:38) {  
      ...
      if (c1_sum$adj.r.squared > 0.7) AVI_index <- paste("##### ##### AVI1: ", k, " ", j, " ", h)
      if (c1_sum$adj.r.squared > 0.7) print(AVI_index, attach=TRUE)
      if (c1_sum$adj.r.squared > 0.7) print(c1_sum$adj.r.squared, attach=TRUE)
      
      if (c2_sum$adj.r.squared > 0.7) AVI_index <- paste("##### ##### AVI2: ", k, " ", j, " ", h)
      if (c2_sum$adj.r.squared > 0.7) print(AVI_index, attach=TRUE)
      if (c2_sum$adj.r.squared > 0.7) print(c2_sum$adj.r.squared, attach=TRUE)
      
      if (c3_sum$adj.r.squared > 0.7) AVI_index <- paste("##### ##### AVI3: ", k, " ", j, " ", h)
      if (c3_sum$adj.r.squared > 0.7) print(AVI_index, attach=TRUE)
      if (c3_sum$adj.r.squared > 0.7) print(c3_sum$adj.r.squared, attach=TRUE)
