...
min_car <- refl_b[1,1:16]
med_car <- refl_b[18,1:16]
max_car <- refl_b[33,1:16]
...
pdf(file="found_AVI.pdf", width=4, height=7.2)

par(mfrow=c(1,3))

plot(wavel[1:16], min_car, ylim=c(500,maxr), xlim=c(400,600), col="white")
par(new=T)
lines(wavel[1:16], min_car, ylim=c(500,maxr))
points(wavel[1:16], min_car, ylim=c(500,maxr), pch=15, cex=0.7)
# plot triangles
# for car_min
par(new=T)
bnds <- c(1,13,15)
...
plot(wavel[1:16], min_car, ylim=c(500,maxr), xlim=c(400,600), col="white")
par(new=T)
lines(wavel[1:16], med_car, add=T, ann=F, axes=F, ylim=c(0,maxr), col="black")
points(wavel[1:16], med_car, ylim=c(500,maxr), pch="+", cex=0.7)
# for car_min
par(new=T)
...
plot(wavel[1:16], min_car, ylim=c(500,maxr), xlim=c(400,600), col="white")
par(new=T)
lines(wavel[1:16], max_car, add=T, ann=F, axes=F, ylim=c(0,maxr), col="black")
points(wavel[1:16], max_car, ylim=c(500,maxr), pch=0, cex=0.7, col="black")
